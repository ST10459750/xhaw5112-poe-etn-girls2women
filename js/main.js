(function ($) {
    ...
    //         $(".dropdown-submenu .dropdown-menu").not($(this).siblings()).removeClass("show");
    //     });
    ...
    $(document).ready(function () {
        ...
        $('.dropdown').on('click', function (e) {
            ...
            if ($dropdownMenu.is(':visible')) {
                ...
                $('.dropdown-menu').slideUp(); // Close any open dropdowns
        ...
        $('.dropdown-submenu').on('mouseleave', function () {
            $(this).children('.dropdown-menu').stop(true, true).delay(100).slideUp();
        });
